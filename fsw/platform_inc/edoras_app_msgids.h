...
#define EDORAS_APP_CANADARM_TLM_MID (CFE_PLATFORM_TLM_MID_BASE + 0x29) /* APID 41 */
#define EDORAS_APP_DEXTRE_TLM_MID   (CFE_PLATFORM_TLM_MID_BASE + 0x2A) /* APID 42 */
#define EDORAS_APP_MBS_TLM_MID      (CFE_PLATFORM_TLM_MID_BASE + 0x2B) /* APID 43 */
#define EDORAS_APP_SOLAR_TLM_MID    (CFE_PLATFORM_TLM_MID_BASE + 0x2C) /* APID 44 */
